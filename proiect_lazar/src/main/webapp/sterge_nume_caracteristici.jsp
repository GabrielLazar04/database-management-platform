...
<head>
  ...
  <title>Ștergere Caracteristici Animale</title>
  <style>
...
<body>
  ...
  <div class="overlay-content">
    ...
    %>
      ...
      <a href="tabela_caracteristici_animale.jsp" class="btn">Înapoi la Tabela Caracteristici Animale</a>
    <% 
      } else {
        
        jb.connect();
        jb.stergeDateTabela(s, "caracteristici_animale", "idcaracteristici_animale");
        jb.disconnect();
    %>
