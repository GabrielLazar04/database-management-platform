...
<head>
  ...
  <title>Modificare Tabela Caracteristici</title>
  <style>
    ...
    .message {
      font-size: 1.2rem;
      margin-bottom: 2rem;
      color: #4caf50; /* verde pentru succes */
      font-weight: bold;
    }
...
<body>
  ...
  <div class="overlay-content">
    <header>
      <h1>Modificare Tabela Caracteristici</h1>
    </header>

    <%
      
      jb.connect();
      int aux = java.lang.Integer.parseInt(request.getParameter("idcaracteristic"));
      String numecaracteristica = request.getParameter("numecaracteristica");
      String[] valori = { numecaracteristica };
      String[] campuri = { "numecaracteristica" };
      jb.modificaTabela("caracteristici", "idcaracteristic", aux, campuri, valori);
      jb.disconnect();
    %>
