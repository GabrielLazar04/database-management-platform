...
<head>
  ...
  <title>Modifică Tabela Animale</title>
  <style>
...
<body>
  ...
  <div class="overlay-content">
    ...
    <%
      ...
      ResultSet rs = jb.intoarceLinieDupaId("animale", "id_animal", aux);
      rs.first();
    ...
    <form action="m2_animal.jsp" method="post">
      <table>
        <tr>
          ...
          <td><input type="text" name="id_animal" value="<%= aux %>" readonly /></td>
        </tr>
        <tr>
          <td align="right">specie:</td>
          <td><input type="text" name="specie" value="<%= Specie %>" /></td>
        </tr>
        <tr>
