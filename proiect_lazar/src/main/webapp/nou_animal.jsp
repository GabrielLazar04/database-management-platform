...
<body>
  ...
  <div class="overlay-content">
    ...
    <% 
      ...
      if (specie != null) {
          jb.connect();
          jb.adaugaAnimale(specie, nume);
          jb.disconnect();
    %>
    <div class="success-message">Datele au fost adăugate cu succes!</div>
    <% 
      } else { 
    %>
    ...
    <form action="nou_animal.jsp" method="post">
      <table>
        <tr>
          ...
          <td><input type="text" name="specie" size="40" required /></td>
        </tr>
        <tr>
      ...
      <input type="submit" value="Adaugă Animal" />
    </form>
    <% } %>
